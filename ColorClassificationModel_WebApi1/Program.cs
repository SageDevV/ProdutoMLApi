...
builder.Services.AddPredictionEnginePool<ColorClassificationModel.ModelInput, ColorClassificationModel.ModelOutput>()
    .FromFile("ColorClassificationModel.mlnet");
...
app.MapPost("/predict",
    async (PredictionEnginePool<ColorClassificationModel.ModelInput, ColorClassificationModel.ModelOutput> predictionEnginePool, string imagePath) =>
    {
