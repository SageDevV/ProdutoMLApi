...
builder.Services.AddPredictionEnginePool<ProductClassification.ModelInput, ProductClassification.ModelOutput>()
    .FromFile("ProductClassification.mlnet");
...
app.MapPost("/predict",
    async (PredictionEnginePool<ProductClassification.ModelInput, ProductClassification.ModelOutput> predictionEnginePool, string imagePath) =>
    {
