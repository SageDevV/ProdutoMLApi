...
builder.Services.AddPredictionEnginePool<ShapeClassificationModel.ModelInput, ShapeClassificationModel.ModelOutput>()
    .FromFile("ShapeClassificationModel.mlnet");
...
app.MapPost("/predict",
    async (PredictionEnginePool<ShapeClassificationModel.ModelInput, ShapeClassificationModel.ModelOutput> predictionEnginePool, string imagePath) =>
    {
